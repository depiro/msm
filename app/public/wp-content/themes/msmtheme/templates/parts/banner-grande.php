...
<div class="banner-consultas d-flex align-items-center justify-content-between p-4 rounded-3 mb-4" style="background-color: #f7f8f4;">
  ...
  <?php if ($image_url): ?>
    <div class="image-content ms-4">
      <img src="<?php echo esc_url($image_url); ?>" alt="Ilustración" style="max-height: 140px; height: auto;" />
    </div>
  <?php endif; ?>
</div>
