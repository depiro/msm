...
<div id="main-content" class="container mb-5">
	...
	<div class="row my-md-5">
		<div class="col-12 py-5">
			<h2 class="msm-font-xl mb-1 post-title">Licencias de Conducir</h2>
		...
		<div class="col-12 col-md-3">
			<aside class="sidebar-card p-4 rounded shadow-sm">
				<p class="text-white  mb-4 fs-6">Tramitación y aprobación de permisos relacionados con construcciones, ampliaciones y demoliciones, asegurando el cumplimiento de las normativas municipales.</p>

				<h5 class="text-acento fw-bold mb-2">Horario de atención</h5>
				<ul class="list-unstyled text-white text-sm mb-4 ps-3">
					<li>Lunes a Sábados de 8:00 a 14:00 hs.</li>
				</ul>

				<h5 class="text-acento fw-bold mb-2">Contacto</h5>
				<ul class="list-unstyled text-white text-sm ps-3">
					<li><strong>Teléfono:</strong> (11) 60917130 <strong>interno</strong> 6330</li>
					<li><strong>Email:</strong> info.empleo@msm.gov.ar</li>
					<li><strong>Instagram:</strong> Oficina_obras_particulares</li>
				</ul>
			</aside>
		</div>
	</div>
