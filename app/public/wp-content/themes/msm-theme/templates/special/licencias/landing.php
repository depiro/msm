				...
				<div class="col-12 mt-5">
					<div class="alert alert-warning mt-4 mb-4 p-4" role="alert">
						...
						<ul class="mb-0 ps-3">
							...
							<li>Excluyente que tu DNI tenga domicilio en San Miguel y sea el último ejemplar (se acepta DNI DIGITAL).</li>
							<li>Si tu licencia está vencida por más de 90 días, deberás realizar exámen teórico/práctico.</li>
							<li>Jubilados +70 años: rinden exámen teórico/práctico anualmente. Quedan eximidos del pago del impuesto municipal.</li>
							<li>Si tu licencia está vencida, deberás asistir acompañado por una persona con licencia vigente para realizar el exámen práctico.</li>
							<li>Más información en la guía de trámites.</li>
						</ul>
					</div>
				</div>
			</div>
