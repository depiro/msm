...
<div id="main-content" class="container mb-5">
	...
	<div class="col-12 py-5">
			<h2 class="msm-font-xl mb-1 post-title">Turnos</h2>
			<p class="fz-18">Solicitá tu turno para <span style="font-weight: bold; color: #0095da;">obtener, renovar,
			ampliar o duplicar</span> tu licencia de conducir.</p>
		</div>
