    ...
    <div class="container text-white text-center row justify-content-center align-items-center py-3">
      ...
      <div class="col-12 col-md-4 d-flex align-items-center justify-content-center justify-content-md-start mb-3 mb-md-0">
        <div class="d-flex flex-column align-items-center align-items-md-start p-3 text-white">
          ...
          <span class="fz-16 text-center text-md-start fst-italic">Domingo Faustino Sarmiento 1551, San Miguel<br>Provincia de Buenos Aires, Argentina</span>
        </div>
      </div>
      ...
      <div class="col-12 col-md-4 d-none d-md-flex justify-content-center">
        <a class="logo-footer" href="<?php echo HOME_URI; ?>" title="<?php bloginfo('name') ?> | Provincia de Buenos Aires. Argentina">
      ...
      <div class="col-12 col-md-4 d-flex flex-column align-items-center align-items-md-start">
        <p class="fz-16 d-flex flex-wrap align-items-center justify-content-center justify-content-md-start mb-1 gap-2">
          <a class="text-white text-decoration-none" href="<?php echo HOME_URI; ?>/terminos-y-condiciones/">Términos y Condiciones</a>
          <span>|</span>
