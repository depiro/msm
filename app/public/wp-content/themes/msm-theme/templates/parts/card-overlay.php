...
<div class="<?php echo esc_attr($col_class); ?> mb-4">
    <!-- Wrapper -->
    <a href="<?php echo esc_url($link); ?>" class="text-decoration-none d-block h-100" style="color: inherit;">
        <div class="card-overlay-wrapper position-relative"
            ...
            ?>
            <div class="<?php echo esc_attr($bg_class); ?>" style="<?php echo $bg_style . $pos_style; ?> z-index: 0;">
            </div>
            ...
            <div class="container-fluid position-relative d-flex <?php echo esc_attr($justify_class); ?> px-0"
                ...
                <div class="overlay-box bg-white p-4 rounded shadow-sm" style="max-width: 450px; width: 100%;">
                    <h3 class="fw-bold mb-3" style="color: var(--bs-body-color);"><?php echo esc_html($title); ?></h3>
