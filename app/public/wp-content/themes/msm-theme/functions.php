...
function msm_card_shortcode($atts)
{
    ...
    switch ($variant) {
        ...
        case '3': // Variante tramite
            ...
            <div class="col-12">
                <a href="<?php echo esc_url($atts['link']); ?>">
                    <div class="card-tramite d-flex border rounded overflow-hidden"
                        style="min-width: 250px; <?php echo $height_style; ?>">
        ...
        default:
            ...
            <div class="col-12">
                <a href="<?php echo esc_url($atts['link']); ?>"
                    class="text-decoration-none <?php echo esc_attr($variant_class); ?>">
